...
public enum PointTypeEnum {
    ...
    public static final String POINT_ICON_BACKGROUND_NAME = "points/background";
    public static final Image POINT_ICON_BACKGROUND = ResourceManager.getGraphics(POINT_ICON_BACKGROUND_NAME);
